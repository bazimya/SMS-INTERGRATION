...
if(isset($_POST['submit'])){
    ...
    $named = mysqli_real_escape_string($conn, $_POST['name']);
    echo
    $message = mysqli_real_escape_string($conn, $_POST['message']);

    // insert the message in the database
    $query = $conn->query("INSERT INTO messages(userId, senderName, message) VALUES ('$userId', '$named', '$message') ") or die($conn->error);
